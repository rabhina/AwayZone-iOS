...
class loginVC: UIViewController {
    ...
    @IBAction func signinAction(_ sender: Any) {
        ...
        if (!Utilities.sharedInstance.isValidEmail(testStr: emailTXT.text!)) {
            ...
            WebserviceClass.sharedInstance.apiCallWithParametersUsingPOST(methodName: KLogin, paramDictionary: paramDict as NSDictionary?, onCompletion: { (responseDict) in
