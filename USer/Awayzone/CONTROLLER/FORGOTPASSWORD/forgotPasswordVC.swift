...
class forgotPasswordVC: UIViewController {
    ...
    @IBAction func resetAction(_ sender: Any) {
        ...
        if (!Utilities.sharedInstance.isValidEmail(testStr: emailTXT.text!)) {
            ...
            WebserviceClass.sharedInstance.apiCallWithParametersUsingPOST(methodName: KForgot, paramDictionary: paramDict as NSDictionary?, onCompletion: { (responseDict) in
