...
class UpdatePasswordVC: UIViewController {
    ...
    @IBAction func actionUpdatePassword(_ sender: Any) {
        ...
        if (oldPasswordTF.text?.isEmpty)! {
            ...
            WebserviceClass.sharedInstance.apiCallWithParametersUsingPOST(methodName: KUpdatePassword, paramDictionary: paramDict as NSDictionary?, onCompletion: { (responseDict, isSuccess) in
