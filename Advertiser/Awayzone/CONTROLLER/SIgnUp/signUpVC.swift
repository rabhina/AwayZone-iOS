...
class signUpVC: UIViewController {
    ...
    @IBAction func signUpAction(_ sender: Any) {
        ...
        if (!Utilities.sharedInstance.isValidEmail(testStr: emailTXT.text!)) {
            ...
            WebserviceClass.sharedInstance.apiCallWithParametersUsingPOST(methodName: KSignup, paramDictionary: paramDict as NSDictionary?, onCompletion: { (responseDict, isSuccess) in
